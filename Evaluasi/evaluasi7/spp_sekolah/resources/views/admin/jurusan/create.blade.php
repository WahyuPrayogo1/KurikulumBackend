...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{route('jurusan.store')}}" class="forms-sample" method="POST" enctype="multipart/form-data">
            @csrf
          ...
          <input type="text" class="form-control" id="exampleInputName1" name="nama_jurusan" >
          </div>
          <div class="form-group">
