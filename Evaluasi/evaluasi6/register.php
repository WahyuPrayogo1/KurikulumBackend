...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="style/global/vendor/flag-icon-css/flag-icon.css">
        <link rel="stylesheet" href="style/assets/examples/css/pages/register-v2.css">
  ...
  <body class="animsition page-register-v2 layout-full page-dark">
    ...
    <div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
      <div class="page-content">
        <div class="page-brand-info">
          <div class="brand">
            <img class="brand-img" src="style/assets/images/logo@2x.png" alt="...">
            <h2 class="brand-text font-size-40">PONDOK IT</h2>
          </div>
          <p class="font-size-20">Welcome to Pondok IT dimana tempat belajar al-quran dan IT di satukan </p>
        </div>

        <div class="page-register-main animation-slide-left animation-duration-1">
          <div class="brand hidden-md-up">
            <img class="brand-img" src="style/assets/images/logo-colored@2x.png" alt="...">
    ...
    <script src="style/global/vendor/slidepanel/jquery-slidePanel.js"></script>
        <script src="style/global/vendor/jquery-placeholder/jquery.placeholder.js"></script>
    ...
    <script src="style/global/js/Plugin/switchery.js"></script>
        <script src="style/global/js/Plugin/jquery-placeholder.js"></script>
        <script src="style/global/js/Plugin/animate-list.js"></script>
...
use KodingWaelah\autoloadLogin;
...
if (isset($_POST['submit'])) {
    ...
    $tampil = new KodingWaelah\autoloadLogin;
    $tampil->register($nama,$email,$password);
